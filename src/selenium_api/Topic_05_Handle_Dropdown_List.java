...
//		}
	...
	public void TC_02_Handle_Custom_Dropdown_List() throws InterruptedException {
		...
		Assert.assertTrue(driver
				.findElement(By.xpath("//span[@id='number-button']//span[@class='ui-selectmenu-text' and text()='14']"))
				.isDisplayed());
		...
		selectItemFromCustomDropDownList("//mat-select[@role ='listbox' and @id='mat-select-5']", "//mat-option/span",
				"Washington");
		Assert.assertTrue(driver
				.findElement(By.xpath(
						"//mat-select[@role ='listbox' and @id='mat-select-5']//span[contains(text(),'Washington')]"))
				.isDisplayed());
